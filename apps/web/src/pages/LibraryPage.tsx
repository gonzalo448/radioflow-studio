...
export function LibraryPage() {
  ...
  return (
    <section className="card">
      ...
      <p className="muted">
        Búsqueda por metadatos; subida multipart a <code>data/media/uploads</code>; nota semántica con Ollama si la API
        tiene <code>OLLAMA_BASE_URL</code>.
      </p>
      {msg && <p className="error">{msg}</p>}
      <form className="row" onSubmit={onSearch}>
        <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Buscar título / artista…" />
